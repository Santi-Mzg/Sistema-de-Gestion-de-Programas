...
public class EmailService {
    ...
    public void sendEmailNuevoUsuario(String destinatario, String legajo, String password) {
        try {
            ...
            helper.setFrom("silabus.uns@gmail.com", "Sílabus-UNS");
            helper.setTo(destinatario);
            helper.setSubject("Bienvenido a Sílabus-UNS");
            ...
            String htmlBody = String.format(
                    "<div style='font-family: sans-serif; padding: 20px; color: #333;'>" +
                            ...
                            "    <p style='margin: 5px 0 0 0;'><strong>Contraseña:</strong> <code style='background:#fff; padding:2px 5px;'>%s</code></p>" +
                            "  </div>" +
                            "  <div style='margin-top: 25px;'>" +
                            "    <a href='https://https://sistema-de-gestion-de-programas-fro.vercel.app/login' style='background-color: #2563eb; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Acceder al Sistema</a>" +
                            "  </div>" +
                            "</div>",
                    legajo, password
            );
    ...
    public void sendEmailNuevoDepartamento(String destinatario, String departamentoName) {
        try {
            ...
            helper.setFrom("silabus.uns@gmail.com", "Sílabus-UNS");
            helper.setTo(destinatario);
            helper.setSubject("Acceso a Nuevo Departamento en Sílabus-UNS");
    ...
    public void sendEmailRecuperarPassword(String destinatario, String newPassword) {
        try {
            ...
            helper.setFrom("silabus.uns@gmail.com", "Sílabus-UNS");
            helper.setTo(destinatario);
            helper.setSubject("Nueva Contraseña - Sílabus-UNS");
            ...
            String htmlBody = String.format(
                    "<div style='font-family: sans-serif; padding: 20px; color: #333;'>" +
                            ...
                            "    <strong style='font-size: 24px; color: #1e40af; letter-spacing: 2px;'>%s</strong>" +
                            "  </div>" +
    ...
    @Async
    public void sendEmailNotificacionCargaAdministrativo(String destinatario, UserEntity profesor, MateriaEntity materia) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            ...
            helper.setFrom("silabus.uns@gmail.com", "Sílabus-UNS");
            helper.setTo(destinatario);
            helper.setSubject("Nuevo Programa Cargado: " + materia.getNombre() + " (" + materia.getCodigo() + ") - Sílabus-UNS");

            // Diseño HTML básico pero elegante
            String htmlBody = String.format(
                    "<div style='font-family: sans-serif; padding: 20px; color: #333;'>" +
    ...
    @Async
    public void sendEmailNotificacionCargaDocente(String destinatario, ProgramaEntity programa, CarreraEntity carrera) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            ...
            helper.setFrom("silabus.uns@gmail.com", "Sílabus-UNS");
            helper.setTo(destinatario);
            helper.setSubject("Revisión Pendiente: " + programa.getMateria().getNombre() + " (" + programa.getMateria().getCodigo() + ") - Sílabus-UNS");
            ...
            String htmlBody = String.format(
                    "<div style='font-family: sans-serif; padding: 20px; color: #333;'>" +
                            ...
                            "  <div style='margin-top: 25px;'>" +
                            "    <a href='https://tusistema.uns.edu.ar/revisiones' style='background-color: #2563eb; color: white; padding: 10px 18px; text-decoration: none; border-radius: 4px; font-weight: bold;'>Ir a Revisar Programa</a>" +
                            "  </div>" +
                            "  <br />" +
                            "  <hr style='border: 0; border-top: 1px solid #eee;' />" +
                            "  <p style='font-size: 12px; color: #777;'>Sistema de Gestión de Programas UNS - Notificación de flujo de trabajo.</p>" +
                            "</div>",
                    carrera.getNombre(),
                    programa.getMateria().getNombre(), programa.getMateria().getCodigo(), programa.getAnio()
            );
    ...
    @Async
    public void sendEmailNotificacionAprobacionComision(String destinatario, UserEntity secretaria, MateriaEntity materia) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            ...
            helper.setFrom("silabus.uns@gmail.com", "Sílabus-UNS");
            helper.setTo(destinatario);
            helper.setSubject("Revisión Pendiente: " + materia.getNombre() + " (" + materia.getCodigo() + ") - Sílabus-UNS");
            ...
            String htmlBody = String.format(
                    "<div style='font-family: sans-serif; padding: 20px; color: #333;'>" +
                            ...
                            "  <a href='https://tu-sistema-uns.edu.ar/' style='display: inline-block; background-color: #2563eb; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin-top: 10px;'>Acceder al Sistema</a>" +
                            "  <br /><br />" +
                            "  <hr style='border: 0; border-top: 1px solid #eee;' />" +
                            "  <p style='font-size: 12px; color: #777;'>Mensaje generado automáticamente por el Sistema de Gestión de Programas UNS.</p>" +
                            "</div>",
                    materia.getNombre(), materia.getNombre(), materia.getCodigo(), materia.getDepartamento().getNombre()
            );
    ...
    @Async
    public void sendEmailNotificacionRechazo(String destinatarioEmail, UserEntity destinatario, Rol rolEmisor, UserEntity emisor, MateriaEntity materia, String justificacion) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            ...
            helper.setSubject("Corrección Requerida: " + materia.getNombre() + " - Sílabus-UNS");
            ...
            String htmlBody = String.format(
                    "<div style='font-family: sans-serif; padding: 20px; color: #333;'>" +
                            ...
                            "    <a href='https://tusistema.uns.edu.ar/' style='background-color: #dc2626; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Ir al Sistema</a>" +
                            "  </div>" +
                            "  <br />" +
                            "  <hr style='border: 0; border-top: 1px solid #eee;' />" +
                            "  <p style='font-size: 12px; color: #777;'>Este es un mensaje automático del Sistema de Gestión de Programas UNS.</p>" +
                            "</div>",
                    destinatario.getNombre(), rolEmisor, emisor.getNombre(), materia.getNombre(), materia.getCodigo(), justificacion
            );
