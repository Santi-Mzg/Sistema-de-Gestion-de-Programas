...
export const deleteUserFromDepartamento = (
    deptId: number,
    id: number,
 ) => {
      ...
      return customInstance<void>(
      {url: `/api/departamentos/${deptId}/usuarios/${id}`, method: 'DELETE'
    },
      );
    }
...
export const getDeleteUserFromDepartamentoMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteUserFromDepartamento>>, TError,{deptId: number;id: number}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof deleteUserFromDepartamento>>, TError,{deptId: number;id: number}, TContext> => {

const mutationKey = ['deleteUserFromDepartamento'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteUserFromDepartamento>>, {deptId: number;id: number}> = (props) => {
          const {deptId,id} = props ?? {};

          return  deleteUserFromDepartamento(deptId,id,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteUserFromDepartamentoMutationResult = NonNullable<Awaited<ReturnType<typeof deleteUserFromDepartamento>>>
    
    export type DeleteUserFromDepartamentoMutationError = unknown

    export const useDeleteUserFromDepartamento = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteUserFromDepartamento>>, TError,{deptId: number;id: number}, TContext>, }
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteUserFromDepartamento>>,
        TError,
        {deptId: number;id: number},
        TContext
      > => {

      const mutationOptions = getDeleteUserFromDepartamentoMutationOptions(options);
